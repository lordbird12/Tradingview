                    ...
                    <div class="sidebar-inner slimscroll">
                        <div id="sidebar-menu" class="sidebar-menu">
                            <ul>
                                ...
                                >
                                    <Link to="DailyList"
                                    ><i class="la la-bell"></i> <span>Daily</span></Link>
                                </li>

                                <li
                                    className={
                                        this.props.location.pathname == "/CompanyList" ? "active" : ""
                                    }
                                    style={{ display: this.state.menu_view_3 == 1 ? "" : "none" }}
                                >
                                    <Link to="CompanyList"
                                    ><i class="la la-home"></i> <span>Company</span></Link>
                                </li>

                                <li
                                    className={
                                        this.props.location.pathname == "/EmployeeList" ? "active" : ""
                                    }
                                    style={{ display: this.state.menu_view_4 == 1 ? "" : "none" }}
                                >
                                    <Link to="EmployeeList"
                                    ><i class="la la-user"></i> <span>User</span></Link>
                                </li>

                                <li
                                    className={
                                        this.props.location.pathname == "/Permission" ? "active" : ""
                                    }
                                    style={{ display: this.state.menu_view_5 == 1 ? "" : "none" }}
                                >
                                    <Link to="Permission"
                                    ><i class="la la-key"></i> <span>Permission</span></Link>
                                </li>
                                ...
                                >
                                    <Link to="LogList"
                                    ><i class="la la-history"></i> <span>Log</span></Link>
                                </li>
