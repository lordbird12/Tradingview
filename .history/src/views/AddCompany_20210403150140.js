                ...
                <div class="card-body">
                    <form>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8"><input type="text" id="text-input" name="name" placeholder="Name" class="form-control" onChange={this.onchange.bind(this)} /></div>
                        </div>

                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Symbol</label></div>
                            <div class="col-12 col-md-8"><input type="text" id="text-input" name="symbol" placeholder="symbol" class="form-control" onChange={this.onchange.bind(this)} /></div>
                        </div>
