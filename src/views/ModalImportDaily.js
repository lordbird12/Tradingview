...
import DailogImportDaily from './DailogImportDaily';

const ModalImportDaily = (props) => {
    const {
        buttonLabel,
        className,
        company_id,
    ...
    return (
        <div>
            ...
            <Modal isOpen={modal} toggle={toggle}class="modal custom-modal fade" size='lg' >
                <ModalHeader toggle={toggle} ><h4 style={{ position: "absolute" }}>Import Daily Data </h4></ModalHeader>
                <ModalBody>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="col-12 col-md-9">
                                ...
                                <br />
                                <div class="row mt-2">
                                    <button className="btn btn-sm btn-link" onClick={() => { window.open(API.BASE_URL + '/api/download_file/daily.csv') }}>fomat data</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default ModalImportDaily;