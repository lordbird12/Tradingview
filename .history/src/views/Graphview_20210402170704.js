...
export default class DailyList extends Component {
  ...
  render() {
    ...
    return (
      <div class="account-page" style="margin:0px !important;">
        <div class="main-wrapper" style="margin:0px !important;">
          <div className="content container-fluid" style="margin:0px !important;">
            {/* //header */}
